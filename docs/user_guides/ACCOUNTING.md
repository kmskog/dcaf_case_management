...
This workflow shows patients in all cities who have been marked as Pledge Sent. You can mark them as Fulfilled (e.g. mark that the clinic cashed the pledge for that patient) by searching for the patient, clicking the pen icon, and then entering the Fulfillment information for that patient.
