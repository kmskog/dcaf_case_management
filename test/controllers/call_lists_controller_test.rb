...
class CallListsControllerTest < ActionDispatch::IntegrationTest
  before do
    ...
    @city = create :city
    @patient_1 = create :patient, name: 'Susan Everyteen', city: @city
    @patient_2 = create :patient, name: 'Yolo Goat', city: @city
  ...
  describe 'reorder call list' do
    ...
    it 'should rerack order keys' do
      ...
      assert_equal @user.call_list_patients(@city).map { |x| x.id.to_s }, @ids
    end
  end
end
